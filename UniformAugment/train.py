...
from UniformAugment.common import get_logger, EMA, add_filehandler
from UniformAugment.data import get_dataloaders
...
def train_and_eval(tag, dataroot, test_ratio=0.0, cv_fold=0, reporter=None, metric='last', save_path=None, only_eval=False, local_rank=-1, evaluation_interval=5):
    ...
    if not tag or not is_master:
        from UniformAugment.metrics import SummaryWriterDummy as SummaryWriter
